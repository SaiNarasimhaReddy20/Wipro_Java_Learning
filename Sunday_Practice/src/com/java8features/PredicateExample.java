...
// Stream is where it will collect the items from collections 
// and perform some operations on it 
// and then if you want save it back to collections
public class PredicateExample {
	...
	public static void main(String[] args) {
		...
		// It gives a boolean valued function 
		// with one input and returns a boolean that is boolean test(T t);
