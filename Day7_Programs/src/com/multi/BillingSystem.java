...
public class BillingSystem {
    ...
    public synchronized void waitForBilling(String user) {
        ...
        System.out.println("Billing done for " + user);
        isBilled = false; // Reset for next user
    }
}
...
class Userthread extends Thread {
    ...
    public void run() {
        ...
        // Call directly instead of using a new thread
        billingSystem.billUser(username);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("All users have completed their orders and billing.");
    }
}
